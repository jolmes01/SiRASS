        ...
        if (conexion != null) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    institucion.setUltimaModif(rs.getDate("ultimaModif"));
        ...
        if (conexion != null) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    plantel.setUltimaModif(rs.getDate("ultimaModif"));
    ...
    public int insertInstitucion(Institucion institucion) {
        ...
        if (conexion != null) {
            ...
            try {
                ...
                // 2) Establecer valores a insertar
                if (institucion.getPlantel().getId() == 0) {
                    ps.setNull(2, Types.NULL);
                } else {
                    ps.setInt(2, institucion.getPlantel().getId());
                }
                ps.setString(3, institucion.getDomicilio());
                ps.setString(4, institucion.getArea());
                ps.setString(5, institucion.getResponsable());
                ps.setString(6, institucion.getCargo());
                ps.setString(7, institucion.getTel());
                ps.setString(8, institucion.getTelExt());
                ps.setString(9, institucion.getEmail());
                ps.setString(10, institucion.getModificadoPor());
                // 3) Realizar query
                status = ps.executeUpdate();
                if (status > 0) {
                    // Si se realizó establecer el ID del Prestador
