...
//            status = prestadorDAO.insert(prestador);
        }
...
//        String nombre = request.getParameter("nombreInstitucion");
//        String idInstitucionStr = request.getParameter("institucionList");
...
//        if (idInstitucionStr != null) {
//            // Establecer el ID
//            institucion.setId(Integer.parseInt(idInstitucionStr));
//        } else {
//            // Si la institución no existe registrar nueva
