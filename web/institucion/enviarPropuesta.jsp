<%-- 
    ...
    Created on : 29/04/2012, 12:50:43 PM
    Author     : JL Macias
			...
			<div class = "row-fluid">
				...
				<div class = "container bg span7">
					...
					<header>
						...
						<p>Envia una propuesta para que tengas prestadores contigo en Servicio Social.</p>
					</header>
					<!-- Formulario
					============================================== -->
					<form class = "form-horizontal" name = "enviaPropuesta" id = "enviaPropuesta">
						<div id = "formulario">
							...
							<div class = "row">
								...
								<div class = "span7 well">
									<fieldset>
										<legend> Datos de programa </legend>
